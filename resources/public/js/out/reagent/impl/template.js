...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__21262__auto__,writer__21263__auto__,opt__21264__auto__){
return cljs.core._write.call(null,writer__21263__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__20683__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__20683__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__20683__auto__)){
return or__20683__auto__;
} else {
...
var G__27760 = o;
(G__27760[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__27761__delegate = function (args){
...
while (G__27762__i < G__27762__a.length) {G__27762__a[G__27762__i] = arguments[G__27762__i + 0]; ++G__27762__i;}
  args = new cljs.core.IndexedSeq(G__27762__a,0);
} 
return G__27761__delegate.call(this,args);};
G__27761.cljs$lang$maxFixedArity = 0;
G__27761.cljs$lang$applyTo = (function (arglist__27763){
var args = cljs.core.seq(arglist__27763);
return G__27761__delegate(args);
});
...
var old_27764 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_27764))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_27764)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__20671__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__27767 = jsprops;
(G__27767["defaultValue"] = value);

(G__27767["onChange"] = ((function (G__27767,v,value,on_change){
return (function (p1__27765_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27765_SHARP_);
});})(G__27767,v,value,on_change))
);
...
var vec__27769 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27769,(0),null);
var id = cljs.core.nth.call(null,vec__27769,(1),null);
var class$ = cljs.core.nth.call(null,vec__27769,(2),null);
...
var temp__4427__auto__ = (function (){var G__27771 = cljs.core.meta.call(null,v);
var G__27771__$1 = (((G__27771 == null))?null:reagent.impl.template.get_key.call(null,G__27771));
return G__27771__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__27773_27774 = v;
var G__27773_27775__$1 = (((G__27773_27774 == null))?null:reagent.impl.template.key_from_vec.call(null,G__27773_27774));
var G__27773_27776__$2 = (((G__27773_27775__$1 == null))?null:(jsprops["key"] = G__27773_27775__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__27779 = cljs.core.meta.call(null,argv);
var G__27779__$1 = (((G__27779 == null))?null:reagent.impl.template.get_key.call(null,G__27779));
return G__27779__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__27780 = (((jsprops == null))?{}:jsprops);
(G__27780["key"] = key);
...
var n__21568__auto___27781 = a.length;
var i_27782 = (0);
while(true){
if((i_27782 < n__21568__auto___27781)){
(a[i_27782] = reagent.impl.template.as_element.call(null,(a[i_27782])));

var G__27783 = (i_27782 + (1));
i_27782 = G__27783;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21568__auto___27784 = a.length;
var i_27785 = (0);
while(true){
if((i_27785 < n__21568__auto___27784)){
var val_27786 = (a[i_27785]);
if((cljs.core.vector_QMARK_.call(null,val_27786)) && ((reagent.impl.template.key_from_vec.call(null,val_27786) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27785] = reagent.impl.template.as_element.call(null,val_27786));

var G__27787 = (i_27785 + (1));
i_27785 = G__27787;
continue;
} else {
}
...
var G__27789 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27789) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27789){
